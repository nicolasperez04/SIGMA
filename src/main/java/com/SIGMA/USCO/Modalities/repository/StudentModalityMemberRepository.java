...
public interface StudentModalityMemberRepository extends JpaRepository<StudentModalityMember, Long> {
    ...
    /**
     * Encuentra los miembros de varias modalidades (cualquier estado)
     * @param modalityIds IDs de las modalidades
     * @return Lista de miembros en cualquier estado
     */
    List<StudentModalityMember> findByStudentModalityIdIn(List<Long> modalityIds);
    ...
    List<StudentModalityMember> findByStudentIdIn(List<Long> studentIds);
